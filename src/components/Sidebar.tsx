import { Car, LayoutDashboard, Video, BarChart, MapIcon, Settings } from "lucide-react";
import Link from "next/link";

const navItems = [
  { icon: LayoutDashboard, label: "Dashboard", href: "#" },
  { icon: MapIcon, label: "Live Plan", href: "#" },
  { icon: Video, label: "CCTV Feeds", href: "#", active: true },
