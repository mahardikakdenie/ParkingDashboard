...
import { Plus, RefreshCw, Layers, Edit } from "lucide-react";
  ...
  const columns: Column<ApplicationItem>[] = [
    {
      key: "code",
      header: "Code",
      render: (item) => <span className="font-mono font-semibold text-blue-400">{item.code}</span>,
    },
    {
      key: "name",
      header: "Name",
    ...
    },
    {
      ...
      header: "Type",
      render: (item) => (
        <span className={`px-2 py-0.5 rounded text-[10px] font-mono ${item.is_internal ? "bg-indigo-500/10 text-indigo-300 border border-indigo-500/20" : "bg-purple-500/10 text-purple-300 border border-purple-500/20"}`}>
    ...
    <div className="space-y-6">
      ...
      <DataTable
        ...
        emptyState={{
          ...
          description: "Belum ada aplikasi yang terdaftar dalam sistem.",
